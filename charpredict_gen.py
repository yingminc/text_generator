...
# charcolisttxt = u''
# for (i,j) in char_to_int.items():
#     charcolisttxt += i + ' '+ str(j) + u'\n'
# with codecs.open('/home/yingminc/Documents/dict.txt' , "w" ,'utf-8') as output:
...
gen_txt = ''.join(i for i in gen_txt)

#open: 'a', append
with codecs.open('hoshi_gen.txt', "a" ,'utf-8') as output:
	output.write('\n'+gen_txt)
